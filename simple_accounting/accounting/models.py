...
class Account(models.Model):
  ...
  name: str = models.CharField(max_length=256, blank=False, validators=[non_empty_validator])
  account_number: str = models.CharField(max_length=32, unique=True, blank=False, db_index=True, validators=[non_empty_validator])
